...
for cashier_key, cashier_info in cashier_data.items():
    ...
    row = cashier + (date, check_speed, total_check_count, total_check_sum, average_check)
    summary_data.append(row)

title = ['Кассир', 'Дата', 'Средняя скорость чека', 'Количество чеков', 'Оборот руб.', 'Средний чек']
